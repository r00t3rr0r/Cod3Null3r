...
router.get('/projects/:projectId/tasks', requireUser(ALL_ROLES), async (req: AuthRequest, res: Response) => {
  try {
...
router.get('/projects/:projectId/epics', requireUser(ALL_ROLES), async (req: AuthRequest, res: Response) => {
  try {
    const { projectId } = req.params;
    const userId = req.user?._id;
...
// Update a task
router.put('/tasks/:taskId', requireUser(ALL_ROLES), async (req: AuthRequest, res: Response) => {
  try {
