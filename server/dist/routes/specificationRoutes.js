...
router.post('/generate', requireUser(ALL_ROLES), async (req, res) => {
    try {
...
router.get('/:specId', requireUser(ALL_ROLES), async (req, res) => {
    try {
...
router.get('/:specId/export', requireUser(ALL_ROLES), async (req, res) => {
    try {
        const { specId } = req.params;
...
//# sourceMappingURL=specificationRoutes.js.map