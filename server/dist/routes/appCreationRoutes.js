...
router.post('/questions', requireUser(ALL_ROLES), async (req, res) => {
    try {
...
router.post('/tech-stack', requireUser(ALL_ROLES), async (req, res) => {
    try {
...
router.post('/roadmap', requireUser(ALL_ROLES), async (req, res) => {
    try {
...
router.post('/start', requireUser(ALL_ROLES), async (req, res) => {
    try {
...
//# sourceMappingURL=appCreationRoutes.js.map