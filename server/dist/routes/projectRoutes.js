...
router.post('/', requireUser(ALL_ROLES), async (req, res) => {
    try {
...
// Update a project
router.put('/:id', requireUser(ALL_ROLES), async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user?._id;
...
// Delete a project
router.delete('/:id', requireUser(ALL_ROLES), async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user?._id;
        if (!userId) {
...
// Duplicate a project
router.post('/:id/duplicate', requireUser(ALL_ROLES), async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user?._id;
        if (!userId) {
